(defproject {{raw-name}} "0.1.0-SNAPSHOT"
  ...
  :aliases {"descjop-help" ["new" "descjop" "help"]
            ...
            "descjop-uberapp-osx" ["shell" "electron-packager" "./app/prod" "{{name}}" "--platform=darwin" "--arch=x64" "--electron-version=1.6.0"]
            "descjop-uberapp-app-store" ["shell" "electron-packager" "./app/prod" "{{name}}" "--platform=mas" "--arch=x64" "--electron-version=1.6.0"]
            "descjop-uberapp-linux" ["shell" "electron-packager" "./app/prod" "{{name}}" "--platform=linux" "--arch=x64" "--electron-version=1.6.0"]
