...
return (new CustomEvent(event_name,(function (){var obj14618 = {"detail":data};
return obj14618;
})()));
} else {
...
var args14623 = [];
var len__7923__auto___14629 = arguments.length;
var i__7924__auto___14630 = (0);
while(true){
if((i__7924__auto___14630 < len__7923__auto___14629)){
args14623.push((arguments[i__7924__auto___14630]));

var G__14631 = (i__7924__auto___14630 + (1));
i__7924__auto___14630 = G__14631;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args14623.length)].join('')));
...
var f = (function (){var pred__14626 = cljs.core._EQ_;
var expr__14627 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__14626.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__14627))){
return ((function (pred__14626,expr__14627){
return (function (p1__14619_SHARP_){
return console.warn(p1__14619_SHARP_);
});
;})(pred__14626,expr__14627))
} else {
if(cljs.core.truth_(pred__14626.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__14627))){
return ((function (pred__14626,expr__14627){
return (function (p1__14620_SHARP_){
return console.debug(p1__14620_SHARP_);
});
;})(pred__14626,expr__14627))
} else {
if(cljs.core.truth_(pred__14626.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__14627))){
return ((function (pred__14626,expr__14627){
return (function (p1__14621_SHARP_){
return console.error(p1__14621_SHARP_);
});
;})(pred__14626,expr__14627))
} else {
return ((function (pred__14626,expr__14627){
return (function (p1__14622_SHARP_){
return console.log(p1__14622_SHARP_);
});
;})(pred__14626,expr__14627))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__14633){
var map__14636 = p__14633;
...
var eval_fn = cljs.core.get.call(null,map__14636__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__14638_SHARP_);
});})(new_def))
);
...
return (function (p__14639){
var vec__14640 = p__14639;
var ky = cljs.core.nth.call(null,vec__14640,(0),null);
...
var args14643 = [];
var len__7923__auto___14646 = arguments.length;
var i__7924__auto___14647 = (0);
while(true){
if((i__7924__auto___14647 < len__7923__auto___14646)){
args14643.push((arguments[i__7924__auto___14647]));

var G__14648 = (i__7924__auto___14647 + (1));
i__7924__auto___14647 = G__14648;
continue;
} else {
}
break;
