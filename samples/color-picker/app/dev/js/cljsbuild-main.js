...
hello_desc2.core._main = function() {
  ...
  hello_desc2.core.app.on("window-all-closed", function() {
    return cljs.core.not_EQ_.call(null, cljs.nodejs.process.platform, "darwin") ? hello_desc2.core.app.quit() : null;
  });
